...
> = {
  [ButtonVariant.Primary]: {
    ...
    [ButtonColor.Twitter]: 'btn-primary-twitter.js',
  ...
  [ButtonVariant.Secondary]: {
    ...
    [ButtonColor.Twitter]: 'btn-secondary-twitter.js',
  ...
  [ButtonVariant.Tertiary]: {
    ...
    [ButtonColor.Twitter]: 'btn-tertiary-twitter.js',
  ...
  [ButtonVariant.Float]: {
    ...
    [ButtonColor.Twitter]: 'btn-tertiaryFloat-twitter.js',
  ...
  [ButtonVariant.Subtle]: {
    ...
    [ButtonColor.Twitter]: 'btn-subtle-twitter.js',
